# Licensing notes for FOBS

FOBS is licensed under the **[GNU Affero General Public License v3.0 or
...
>
> As a special exception, the copyright holders of FOBS give you permission to
> combine, link with, and distribute FOBS, or a work based on FOBS, together
...
> resulting work that are FOBS, or a work based on FOBS.
>
...
**If you only install and use FOBS, none of this touches you.** Running the
...
- `app/src/main/java/com/atakmap/android/fobs/plugin/PluginNativeLoader.java`
...
- `app/src/main/java/com/atakmap/android/fobs/plugin/FOBS.java`
- `app/src/main/java/com/atakmap/android/fobs/plugin/FobsPreferenceFragment.java`
